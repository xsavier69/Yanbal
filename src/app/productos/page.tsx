...
export default async function ProductosPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-sky">
      ...
      <main
        id="catalogo"
        className="flex-1 max-w-lg mx-auto w-full px-4 pt-6 pb-10 flex flex-col gap-8"
      >
      ...
      <footer className="border-t border-line py-6 pb-24 text-center text-ink-soft">
      ...
      {/* Franja fija: el segundo motivo por el que alguien está aquí */}
      <div className="invite-strip">
        <Link href="/">¿Te gustaría vender Yanbal? Te cuento cómo empezar</Link>
      </div>
